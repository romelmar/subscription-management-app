  ...
  "node_modules/apexcharts-clevision/dist/apexcharts.common.js"(exports, module) {
    ...
    function g(t2) {
      return function(t3) {
        ...
        if (!t3) return;
        if ("string" == typeof t3) return u(t3, e2);
        var i2 = Object.prototype.toString.call(t3).slice(8, -1);
        "Object" === i2 && t3.constructor && (i2 = t3.constructor.name);
        if ("Map" === i2 || "Set" === i2) return Array.from(t3);
        if ("Arguments" === i2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i2)) return u(t3, e2);
      }(t2) || function() {
    ...
    var p = function() {
      ...
      return r(t2, [{ key: "shadeRGBColor", value: function(t3, e2) {
        ...
        if ("[object Array]" === Object.prototype.toString.call(t3)) {
          for (var e2 = [], a2 = 0; a2 < t3.length; a2++) e2[a2] = this.clone(t3[a2]);
          return e2;
        }
        if ("[object Null]" === Object.prototype.toString.call(t3)) return null;
        if ("[object Date]" === Object.prototype.toString.call(t3)) return t3;
        if ("object" === i(t3)) {
          var s2 = {};
          for (var r2 in t3) t3.hasOwnProperty(r2) && (s2[r2] = this.clone(t3[r2]));
          return s2;
        }
        return t3;
    ...
    var b = function() {
      ...
      return r(t2, [{ key: "drawLine", value: function(t3, e2, i2, a2) {
        ...
        if (z2.attr("index", s2), v2 && z2.attr({ "clip-path": "url(#gridRectMask".concat(A2.globals.cuid, ")") }), "none" !== A2.config.states.normal.filter.type) S2.getDefaultFilter(z2, s2);
        ...
        return void 0 === s2 && (s2 = ""), r2 || (r2 = "start"), h2 && h2.length || (h2 = f2.config.chart.foreColor), n2 = n2 || f2.config.chart.fontFamily, l2 = l2 || "regular", (e2 = Array.isArray(s2) ? f2.globals.dom.Paper.text(function(t4) {
          for (var e3 = 0; e3 < s2.length; e3++) 0 === e3 ? t4.tspan(s2[e3]) : t4.tspan(s2[e3]).newLine();
        ...
        } else "circle" !== i2.shape && i2.shape || (p.isNumber(e2) || (a2 = 0, e2 = 0), s2 = this.drawCircle(a2, { cx: t3, cy: e2, class: i2.class ? i2.class : "", stroke: i2.pointStrokeColor, fill: i2.pointFillColor, "fill-opacity": i2.pointFillOpacity ? i2.pointFillOpacity : 1, "stroke-width": i2.pointStrokeWidth ? i2.pointStrokeWidth : 0, "stroke-opacity": i2.pointStrokeOpacity ? i2.pointStrokeOpacity : 1 }));
        return s2;
        ...
        } else "none" !== i2.config.states.active.filter.type && a2.getDefaultFilter(t3, s2);
    ...
    var v = function() {
      ...
      return r(t2, [{ key: "setOrientations", value: function(t3) {
        ...
        var i2 = this.w;
        if (!t3 || !e2.label.text || e2.label.text && !e2.label.text.trim()) return null;
    ...
    var y = function() {
      ...
      return r(t2, [{ key: "getStackedSeriesTotals", value: function() {
        var t3 = this.w, e2 = [];
        if (0 === t3.globals.series.length) return e2;
        for (var i2 = 0; i2 < t3.globals.series[t3.globals.maxValsInArrayIndex].length; i2++) {
          for (var a2 = 0, s2 = 0; s2 < t3.globals.series.length; s2++) void 0 !== t3.globals.series[s2][i2] && (a2 += t3.globals.series[s2][i2]);
          e2.push(a2);
        }
    ...
    var k = function() {
      ...
      return r(t2, [{ key: "addPointAnnotation", value: function(t3, e2, i2) {
        ...
        } else s2 = (t3.x - a2.globals.minX) / (a2.globals.xRange / a2.globals.gridWidth);
        for (var h2, c2 = [], d2 = 0, g2 = 0; g2 <= t3.seriesIndex; g2++) {
          var u2 = a2.config.yaxis[g2].seriesName;
          if (u2) for (var f2 = g2 + 1; f2 <= t3.seriesIndex; f2++) a2.config.yaxis[f2].seriesName === u2 && -1 === c2.indexOf(u2) && (d2++, c2.push(u2));
        }
    ...
    var L = function() {
      ...
      return r(t2, [{ key: "clippedImgArea", value: function(t3) {
        ...
        if (void 0 === s2.fill.gradient.gradientToColors || 0 === s2.fill.gradient.gradientToColors.length) a2 = "dark" === s2.fill.gradient.shade ? n2.shadeColor(-1 * parseFloat(s2.fill.gradient.shadeIntensity), t3.indexOf("rgb") > -1 ? p.rgb2hex(t3) : t3) : n2.shadeColor(parseFloat(s2.fill.gradient.shadeIntensity), t3.indexOf("rgb") > -1 ? p.rgb2hex(t3) : t3);
    ...
    var P = function() {
      ...
      return r(t2, [{ key: "setGlobalMarkerSize", value: function() {
        ...
        if ((o2.globals.markers.size[e2] > 0 || r2) && (h2 = c2.group({ class: r2 ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(o2.globals.cuid, ")")), Array.isArray(l2.x)) for (var d2 = 0; d2 < l2.x.length; d2++) {
          var g2 = i2;
          ...
          } else void 0 === o2.globals.pointsArray[e2] && (o2.globals.pointsArray[e2] = []), o2.globals.pointsArray[e2].push([l2.x[d2], l2.y[d2]]);
        }
        return h2;
    ...
    var T = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        if (n2.globals.dataChanged && "circle" === p2.shape) if (this.dynamicAnim) {
          ...
          for (var M2 = 0; M2 < n2.globals.collapsedSeries.length; M2++) n2.globals.collapsedSeries[M2].index === s2 && (T2 = 1, a2 = 0);
    ...
    var M = function() {
      ...
      return r(t2, [{ key: "dataLabelsCorrection", value: function(t3, e2, i2, a2, s2, r2, o2) {
        ...
        if (!n2.enabled || !Array.isArray(t3.x)) return d2;
        d2 = o2.group({ class: "apexcharts-data-labels" });
        for (var g2 = 0; g2 < t3.x.length; g2++) if (l2 = t3.x[g2] + n2.offsetX, h2 = t3.y[g2] + n2.offsetY + s2, !isNaN(l2)) {
    ...
    var I = function() {
      ...
      return r(t2, [{ key: "handleBarDataLabels", value: function(t3) {
        ...
        if (c2.enabled && !v2) {
          ...
          if ("vertical" === d2.config.plotOptions.bar.dataLabels.orientation && ("top" === w2 && (c2.textAnchor = y2 ? "end" : "start"), "center" === w2 && (c2.textAnchor = "middle"), "bottom" === w2 && (c2.textAnchor = y2 ? "end" : "start")), this.barCtx.isTimelineBar && this.barCtx.barOptions.dataLabels.hideOverflowingLabels) h2 < p2.getTextRects(m2, parseFloat(c2.style.fontSize)).width && (m2 = "");
    ...
    var z = function() {
      ...
      return r(t2, [{ key: "getAllSeriesEls", value: function() {
        ...
        if (i2.config.series.length > 1) {
          ...
          }), r2 = "asc" === e2 ? 0 : s2.length - 1; "asc" === e2 ? r2 < s2.length : r2 >= 0; "asc" === e2 ? r2++ : r2--) if (-1 !== s2[r2]) {
            a2 = s2[r2];
            break;
          }
        }
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        ...
        for (var r2 = s3.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), o2 = 0; o2 < t3.length; o2++) {
          ...
          for (var y2 = s3.group({ class: "apexcharts-datalabels", "data:realIndex": u2 }), w2 = s3.group({ class: "apexcharts-rangebar-goals-markers", style: "pointer-events: none" }), k2 = 0; k2 < a2.globals.dataPoints; k2++) {
            ...
            } else x2 = (L2 = this.drawRangeColumnPaths(e({ indexes: { i: o2, j: k2, realIndex: u2 }, zeroH: l2, barWidth: v2, xDivision: n2 }, T2))).barHeight;
        ...
        else p2 = o2.config.tooltip.x.formatter(n2), f2 = o2.config.tooltip.x.formatter(l2);
    ...
    var O = function() {
      ...
      return r(t2, [{ key: "isMultiFormat", value: function() {
        ...
        for (var i2 = this.w.config, a2 = this.w.globals, s2 = "boxPlot" === i2.chart.type || "boxPlot" === i2.series[e2].type, r2 = 0; r2 < t3[e2].data.length; r2++) if (void 0 !== t3[e2].data[r2][1] && (Array.isArray(t3[e2].data[r2][1]) && 4 === t3[e2].data[r2][1].length && !s2 ? this.twoDSeries.push(p.parseNumber(t3[e2].data[r2][1][3])) : t3[e2].data[r2].length >= 5 ? this.twoDSeries.push(p.parseNumber(t3[e2].data[r2][4])) : this.twoDSeries.push(p.parseNumber(t3[e2].data[r2][1])), a2.dataFormatXNumeric = true), "datetime" === i2.xaxis.type) {
        ...
        for (var o2 = 0; o2 < t3[e2].data.length; o2++) void 0 !== t3[e2].data[o2].y && (Array.isArray(t3[e2].data[o2].y) ? this.twoDSeries.push(p.parseNumber(t3[e2].data[o2].y[t3[e2].data[o2].y.length - 1])) : this.twoDSeries.push(p.parseNumber(t3[e2].data[o2].y))), void 0 !== t3[e2].data[o2].goals && Array.isArray(t3[e2].data[o2].goals) ? (void 0 === this.seriesGoals[e2] && (this.seriesGoals[e2] = []), this.seriesGoals[e2].push(t3[e2].data[o2].goals)) : (void 0 === this.seriesGoals[e2] && (this.seriesGoals[e2] = []), this.seriesGoals[e2].push(null));
        ...
        if ("array" === t3) {
          if (2 !== e2[n2].data[0][1].length) throw new Error(o2);
          for (var l2 = 0; l2 < e2[i2].data.length; l2++) a2.push(e2[i2].data[l2][1][0]), s2.push(e2[i2].data[l2][1][1]);
        } else if ("xy" === t3) {
          if (2 !== e2[n2].data[0].y.length) throw new Error(o2);
          ...
          }, c2 = 0; c2 < e2[i2].data.length; c2++) h2(c2);
        }
        ...
        if (e2.xaxis.categories.length > 0) i2.labels = e2.xaxis.categories;
          ...
          })), e2.xaxis.convertedCatToNumeric) new R(e2).convertCatToNumericXaxis(e2, this.ctx, i2.seriesX[0]), this._generateExternalLabels(t3);
        ...
        if (e2.axisCharts) {
          if (e2.series.length > 0) for (var s2 = 0; s2 < e2.series[e2.maxValsInArrayIndex].length; s2++) a2.push(s2 + 1);
          e2.seriesX = [];
          for (var r2 = 0; r2 < t3.length; r2++) e2.seriesX.push(a2);
          e2.isXNumeric = true;
        }
        if (0 === a2.length) {
          ...
          for (var o2 = 0; o2 < t3.length; o2++) e2.seriesX.push(a2);
        }
        ...
        return e2.globals.xaxisTooltipFormatter = function(e3) {
          ...
          if (p.isNumber(t4)) {
            if (!e2.config.xaxis.convertedCatToNumeric && "numeric" === e2.config.xaxis.type) {
              if (p.isNumber(e2.config.xaxis.decimalsInFloat)) return t4.toFixed(e2.config.xaxis.decimalsInFloat);
      ...
      return r(t2, [{ key: "scaleSvgNode", value: function(t3, e2) {
        ...
        var e2 = this, i2 = t3.series, a2 = t3.columnDelimiter, s2 = t3.lineDelimiter, r2 = void 0 === s2 ? "\n" : s2, o2 = this.w, n2 = [], l2 = [], h2 = "data:text/csv;charset=utf-8,\uFEFF", c2 = new O(this.ctx), d2 = new B(this.ctx), g2 = function(t4) {
          ...
          if (o2.globals.axisCharts) {
            if ("category" === o2.config.xaxis.type || o2.config.xaxis.convertedCatToNumeric) if (o2.globals.isBarHorizontal) {
            ...
            } else i3 = d2.getLabel(o2.globals.labels, o2.globals.timescaleLabels, 0, t4).text;
        ...
        n2.push(o2.config.chart.toolbar.export.csv.headerCategory), i2.map(function(t4, e3) {
          ...
          o2.globals.axisCharts ? function(t5, e4) {
            if (n2.length && 0 === e4 && l2.push(n2.join(a2)), t5.data && t5.data.length) for (var s3 = 0; s3 < t5.data.length; s3++) {
              n2 = [];
              var r3 = g2(s3);
              if (r3 || (c2.isFormatXY() ? r3 = i2[e4].data[s3].x : c2.isFormat2DArray() && (r3 = i2[e4].data[s3] ? i2[e4].data[s3][0] : "")), 0 === e4) {
                ...
                for (var h3 = 0; h3 < o2.globals.series.length; h3++) n2.push(o2.globals.series[h3][s3]);
              }
    ...
    var G = function() {
      ...
      return r(t2, [{ key: "drawXaxis", value: function() {
        ...
        s2.add(r2);
        for (var o2 = i2.globals.padHorizontal, n2 = [], l2 = 0; l2 < this.xaxisLabels.length; l2++) n2.push(this.xaxisLabels[l2]);
        var h2 = n2.length;
        if (i2.globals.isXNumeric) {
          var c2 = h2 > 1 ? h2 - 1 : h2;
          t3 = i2.globals.gridWidth / c2, o2 = o2 + t3 / 2 + i2.config.xaxis.labels.offsetX;
        } else t3 = i2.globals.gridWidth / n2.length, o2 = o2 + t3 + i2.config.xaxis.labels.offsetX;
        ...
        if (s2.length > 0) {
          ...
          for (var d2 = 0; d2 < r2.length; d2++) e2.placeTextWithEllipsis(r2[d2], r2[d2].textContent, t3.config.yaxis[0].labels.maxWidth - 2 * parseFloat(t3.config.yaxis[0].title.style.fontSize) - 20);
        }
      } }]), t2;
    }();
    var _ = function() {
      ...
      return r(t2, [{ key: "drawGridArea", value: function() {
        ...
        if (s2.config.grid.xaxis.lines.show || s2.config.xaxis.axisTicks.show) {
          ...
          s2.globals.timescaleLabels.length ? function(t4) {
            ...
            if (void 0 !== s2.config.xaxis.tickAmount && "dataPoints" !== s2.config.xaxis.tickAmount) s2.globals.dom.baseEl.querySelectorAll(".apexcharts-text.apexcharts-xaxis-label tspan:not(:empty)").forEach(function(t5, a4) {
              var s3 = t5.getBBox();
        ...
        if (s2.config.grid.yaxis.lines.show) {
          ...
          for (var g2 = 0; g2 < d2 + (this.isTimelineBar ? 1 : 0); g2++) this._drawGridLine({ x1: 0, y1: l2, x2: c2, y2: h2, parent: this.elgridLinesH }), h2 = l2 += s2.globals.gridHeight / (this.isTimelineBar ? d2 : a2);
        }
        ...
        if (i2.config.grid.yaxis.lines.show) for (var n2 = 0, l2 = 0, h2 = i2.globals.gridWidth, c2 = 0; c2 < i2.globals.dataPoints + 1; c2++) this._drawGridLine({ x1: 0, y1: n2, x2: h2, y2: l2, parent: this.elgridLinesH }), l2 = n2 += i2.globals.gridHeight / i2.globals.dataPoints;
    ...
    var j = function() {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        ...
        for (var e2 = [], i2 = Math.ceil(Math.log10(t3)) + 1, a2 = 0; a2 < i2; a2++) e2.push(Math.pow(10, a2));
        ...
        if (r2.logarithmic && o2 <= 5 && (a2.invalidLogScale = true), r2.logarithmic && o2 > 5) a2.allSeriesCollapsed = false, a2.yAxisScale[t3] = this.logarithmicScale(i2);
        else if (i2 !== -Number.MAX_VALUE && p.isNumber(i2)) if (a2.allSeriesCollapsed = false, void 0 === r2.min && void 0 === r2.max || r2.forceNiceScale) {
    ...
    var U = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        if (t3.isXNumeric && function() {
          for (var e3 = 0; e3 < t3.series.length; e3++) if (t3.labels[e3]) for (var i3 = 0; i3 < t3.labels[e3].length; i3++) null !== t3.labels[e3][i3] && p.isNumber(t3.labels[e3][i3]) && (t3.maxX = Math.max(t3.maxX, t3.labels[e3][i3]), t3.initialMaxX = Math.max(t3.maxX, t3.labels[e3][i3]), t3.minX = Math.min(t3.minX, t3.labels[e3][i3]), t3.initialMinX = Math.min(t3.minX, t3.labels[e3][i3]));
        ...
        if (t3.isDataXYZ) {
          for (var e2 = 0; e2 < t3.series.length; e2++) if (void 0 !== t3.seriesZ[e2]) for (var i2 = 0; i2 < t3.seriesZ[e2].length; i2++) null !== t3.seriesZ[e2][i2] && p.isNumber(t3.seriesZ[e2][i2]) && (t3.maxZ = Math.max(t3.maxZ, t3.seriesZ[e2][i2]), t3.minZ = Math.min(t3.minZ, t3.seriesZ[e2][i2]));
        }
        ...
        if (t3.series.length) for (var a2 = 0; a2 < t3.series[t3.maxValsInArrayIndex].length; a2++) for (var s2 = 0, r2 = 0, o2 = 0; o2 < t3.series.length; o2++) null !== t3.series[o2][a2] && p.isNumber(t3.series[o2][a2]) && (t3.series[o2][a2] > 0 ? s2 = s2 + parseFloat(t3.series[o2][a2]) + 1e-4 : r2 += parseFloat(t3.series[o2][a2])), o2 === t3.series.length - 1 && (e2.push(s2), i2.push(r2));
      ...
      return r(t2, [{ key: "checkResponsiveConfig", value: function(t3) {
        ...
        if (0 !== a2.responsive.length) {
          ...
          var r2 = new H({}), o2 = function() {
            ...
            } else for (var l2 = 0; l2 < s2.length; l2++) o3 < s2[l2].breakpoint && (t4 = y.extendArrayProps(r2, s2[l2].options, i2), t4 = p.extend(i2.config, t4), e2.overrideResponsiveOptions(t4));
          };
          if (t3) {
    ...
    var lt = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        } else !t3.target.classList.contains("apexcharts-inactive-legend") && i2 && new z(this.ctx).toggleSeriesOnHover(t3, t3.target);
    ...
    var ht = function() {
      ...
      return r(t2, [{ key: "createToolbar", value: function() {
        ...
        for (var h2 = 0; h2 < r2.length; h2++) b.setAttrs(r2[h2].el, { class: r2[h2].class, title: r2[h2].title }), r2[h2].el.innerHTML = r2[h2].icon, a2.appendChild(r2[h2].el);
        ...
        for (var i2 = 0; i2 < e2.length; i2++) this.elMenuItems.push(document.createElement("div")), this.elMenuItems[i2].innerHTML = e2[i2].title, b.setAttrs(this.elMenuItems[i2], { class: "apexcharts-menu-item ".concat(e2[i2].name), title: e2[i2].title }), this.elMenu.appendChild(this.elMenuItems[i2]);
        ...
        if (void 0 !== t3 || void 0 !== e2) {
          if (!(i2.config.xaxis.convertedCatToNumeric && (t3 < 1 && (t3 = 1, e2 = i2.globals.dataPoints), e2 - t3 < 2))) {
            ...
            if (i2.config.chart.zoom.autoScaleYaxis) o2 = new j(this.ctx).autoScaleY(this.ctx, o2, { xaxis: a2 });
    ...
    var dt = function() {
      ...
      return r(t2, [{ key: "getNearestValues", value: function(t3) {
        ...
        for (var b2, v2 = null, m2 = null, y2 = [], w2 = 0; w2 < r2.globals.seriesXvalues.length; w2++) y2.push([r2.globals.seriesXvalues[w2][0] - 1e-6].concat(r2.globals.seriesXvalues[w2]));
        ...
        }), a2 = 0; a2 < i2.length; a2++) if (-1 !== i2[a2]) {
          e2 = i2[a2];
          break;
        }
        return e2;
    ...
    var ut = function() {
      ...
      return r(t2, [{ key: "moveXCrosshairs", value: function(t3) {
        ...
        } else a2.globals.isBarHorizontal ? h2 -= o2.ttHeight : (o2.ttHeight / 2 + h2 > a2.globals.gridHeight && (h2 = a2.globals.gridHeight - o2.ttHeight + a2.globals.translateY), h2 < 0 && (h2 = 0));
    ...
    var bt = function() {
      ...
      return r(t2, [{ key: "getElTooltip", value: function(t3) {
        ...
        for (var t3 = this.w, e2 = new b(this.ctx), i2 = t3.globals.dom.Paper.select(".apexcharts-bar-area"), a2 = 0; a2 < i2.length; a2++) e2.pathMouseLeave(i2[a2]);
        ...
        if (o2.config.legend.tooltipHoverFormatter) {
          ...
          for (var g2 = 0; g2 < d2.length; g2++) {
            ...
            if (r2) u2.innerHTML = o2.globals.collapsedSeriesIndices.indexOf(p2) < 0 ? x2 : f2;
            else if (u2.innerHTML = p2 === i2 ? x2 : f2, i2 === p2) break;
          }
        }
        if (r2) {
          if (n2.tooltipLabels.drawSeriesTexts({ ttItems: s2, i: i2, j: a2, shared: !this.showOnIntersect && this.tConfig.shared }), l2 && (o2.globals.markers.largestSize > 0 ? n2.marker.enlargePoints(a2) : n2.tooltipPosition.moveDynamicPointsOnHover(a2)), this.tooltipUtil.hasBars() && (this.barSeriesHeight = this.tooltipUtil.getBarsHeight(h2), this.barSeriesHeight > 0)) {
            ...
            for (var y2 = 0; y2 < m2.length; y2++) v2.pathMouseEnter(m2[y2]);
          }
    ...
    var vt = function(t2) {
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        ...
        for (var e2, i3 = t3.indexes, a2 = t3.barHeight, s3 = t3.strokeWidth, r2 = t3.zeroW, o2 = t3.x, n2 = t3.y, l2 = t3.yDivision, h2 = t3.elSeries, c2 = this.w, d2 = n2, g2 = i3.i, u2 = i3.j, p2 = 0, f2 = 0; f2 < this.prevXF.length; f2++) p2 += this.prevXF[f2][u2];
        if (g2 > 0) {
          var x2 = r2;
        ...
        for (var u2, p2 = i3, f2 = 0, x2 = 0; x2 < this.prevYF.length; x2++) f2 += isNaN(this.prevYF[x2][c2]) ? 0 : this.prevYF[x2][c2];
        ...
        } else u2 = l2.globals.gridHeight - o2;
    ...
    var At = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3) {
        ...
        for (var s2 = 0, r2 = 0; r2 < t3.length; r2++) s2 += p.negToZero(t3[r2]);
        var o2 = [], n2 = a2.group();
        ...
        if (i2.globals.dataChanged) {
          for (var c2, d2 = 0, g2 = 0; g2 < i2.globals.previousPaths.length; g2++) d2 += p.negToZero(i2.globals.previousPaths[g2]);
          for (var u2 = 0; u2 < i2.globals.previousPaths.length; u2++) c2 = this.fullAngle * p.negToZero(i2.globals.previousPaths[u2]) / d2, this.prevSectorAngleArr.push(c2);
        }
        ...
        if (0 !== s2.strokeWidth) {
          for (var r2 = [], o2 = 360 / i2.globals.series.length, n2 = 0; n2 < i2.globals.series.length; n2++) r2.push(p.polarToCartesian(this.centerX, this.centerY, i2.globals.radialSize, i2.config.plotOptions.pie.startAngle + o2 * n2));
    ...
    var St = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3) {
        ...
        for (var e2 = this, i2 = this.w, a2 = t3.parent, s2 = new kt(this.ctx), r2 = i2.globals.yAxisScale[0].result.reverse(), o2 = r2.length, n2 = [], l2 = this.size / (o2 - 1), h2 = 0; h2 < o2; h2++) n2[h2] = l2 * h2;
        n2.reverse();
        var c2 = [], d2 = [];
    ...
    var Lt = function() {
      ...
      return r(t2, [{ key: "sameValueSeriesFix", value: function(t3, e2) {
        ...
        } else h2.push(a2 + l2.config.markers.offsetX), c2.push(p.isNumber(e2[r2][o2 + 1]) ? s2 + l2.config.markers.offsetY : null);
        return { x: h2, y: c2 };
        ...
        if (void 0 !== i2[e2][0]) a2 = (s2 = r2.config.chart.stacked && e2 > 0 ? this.lineCtx.prevSeriesY[e2 - 1][0] : this.lineCtx.zeroY) - i2[e2][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] + 2 * (this.lineCtx.isReversed ? i2[e2][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] : 0);
        else if (r2.config.chart.stacked && e2 > 0 && void 0 === i2[e2][0]) {
          for (var o2 = e2 - 1; o2 >= 0; o2--) if (null !== i2[o2][0] && void 0 !== i2[o2][0]) {
    ...
    var Pt = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        if (a2.config.chart.stacked) for (var k2 = l2.length; k2 > 0; k2--) o2.add(l2[k2 - 1]);
        else for (var A2 = 0; A2 < l2.length; A2++) o2.add(l2[A2]);
        return o2;
        ...
        for (var e2 = t3.series, i2 = t3.realIndex, a2 = t3.i, s2 = t3.x, r2 = t3.y, o2 = t3.pX, n2 = t3.pY, l2 = t3.pathsFrom, h2 = t3.linePaths, c2 = t3.areaPaths, d2 = t3.seriesIndex, g2 = t3.lineYPosition, u2 = t3.xArrj, f2 = t3.yArrj, x2 = this.w, v2 = new b(this.ctx), m2 = this.yRatio, y2 = l2.prevY, w2 = l2.linePath, k2 = l2.areaPath, A2 = l2.pathFromLine, S2 = l2.pathFromArea, C2 = p.isNumber(x2.globals.minYArr[i2]) ? x2.globals.minYArr[i2] : x2.globals.minY, L2 = x2.globals.dataPoints > 1 ? x2.globals.dataPoints - 1 : x2.globals.dataPoints, P2 = 0; P2 < L2; P2++) {
          ...
          } else s2 += this.xDivision;
          if (x2.config.chart.stacked) if (a2 > 0 && x2.globals.collapsedSeries.length < x2.config.series.length - 1) {
            g2 = this.prevSeriesY[function(t4) {
              for (var e3 = t4, i3 = 0; i3 < x2.globals.series.length; i3++) if (x2.globals.collapsedSeriesIndices.indexOf(t4) > -1) {
                e3--;
                break;
              }
              return e3 >= 0 ? e3 : 0;
        ...
        if (this.pointsChart) this.scatter.draw(this.elSeries, a2, { realIndex: s2, pointsPos: e2, zRatio: this.zRatio, elParent: this.elPointsMain });
        else {
    ...
    var zt = function() {
      ...
      return r(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, i2) {
        ...
        } else 1 === e2.minDate && 0 === e2.minMonth && this.timeScaleArray.push({ position: n2, value: o2, unit: h2, year: a2, month: p.monthMod(i2 + 1) });
        ...
        } else this.timeScaleArray.push({ position: l2, value: n2, unit: c2, year: s2, month: p.monthMod(a2) });
        ...
        for (var v2 = g2, m2 = 0; m2 < o2; m2++) {
          if (l2 = "hour", f2 >= 24) f2 = 0, l2 = "day", b2 = h2(x2 += 1, b2).month, b2 = c2(x2, b2);
        ...
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.minutesWidthOnXAxis, h2 = t3.secondsWidthOnXAxis, c2 = t3.numberOfMinutes, d2 = a2 + 1, g2 = r2, u2 = o2, f2 = n2, x2 = s2, b2 = (60 - i2 - e2 / 1e3) * h2, v2 = 0; v2 < c2; v2++) d2 >= 60 && (d2 = 0, 24 === (x2 += 1) && (x2 = 0)), this.timeScaleArray.push({ position: b2, value: d2, unit: "minute", hour: x2, minute: d2, day: g2, year: this._getYear(f2, u2, 0), month: p.monthMod(u2) }), b2 += l2, d2++;
      } }, { key: "generateSecondScale", value: function(t3) {
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.secondsWidthOnXAxis, h2 = t3.numberOfSeconds, c2 = i2 + 1, d2 = a2, g2 = r2, u2 = o2, f2 = n2, x2 = s2, b2 = (1e3 - e2) / 1e3 * l2, v2 = 0; v2 < h2; v2++) c2 >= 60 && (c2 = 0, ++d2 >= 60 && (d2 = 0, 24 === ++x2 && (x2 = 0))), this.timeScaleArray.push({ position: b2, value: c2, unit: "second", hour: x2, minute: d2, second: c2, day: g2, year: this._getYear(f2, u2, 0), month: p.monthMod(u2) }), b2 += l2, c2++;
    ...
    var Xt = function() {
      ...
      return r(t2, [{ key: "setupElements", value: function() {
        ...
        if (s2.comboCharts) {
          if (o2.series.length > 0 && x2.push(g2.draw(o2.series, "area", o2.i)), h2.series.length > 0) if (i2.config.chart.stacked) {
            var b2 = new vt(this.ctx, e2);
            x2.push(b2.draw(h2.series, h2.i));
          } else this.ctx.bar = new E(this.ctx, e2), x2.push(this.ctx.bar.draw(h2.series, h2.i));
          ...
          case "area":
            ...
            break;
          case "bar":
            if (a2.chart.stacked) x2 = new vt(this.ctx, e2).draw(s2.series);
            else this.ctx.bar = new E(this.ctx, e2), x2 = this.ctx.bar.draw(s2.series);
            break;
          case "candlestick":
    ...
    * Copyright (c) 2019 Wout Fierens; Licensed MIT */
    ...
    !function(t2, e2) {
      ...
      if (void 0 !== c2.style.animationName && (o2 = true), false === o2) {
        for (var d2 = 0; d2 < l2.length; d2++) if (void 0 !== c2.style[l2[d2] + "AnimationName"]) {
          n2 = h2[d2];
          break;
        }
      }
      ...
      return r(t2, [{ key: "render", value: function() {
        ...
        return new Promise(function(s2, r2) {
          ...
          if ("front" === a2.config.grid.position && o2 && a2.globals.dom.elGraphical.add(o2.el), "front" === a2.config.xaxis.crosshairs.position && i2.crosshairs.drawXCrosshairs(), "front" === a2.config.yaxis[0].crosshairs.position && i2.crosshairs.drawYCrosshairs(), "front" === a2.config.annotations.position && (a2.globals.dom.Paper.add(a2.globals.dom.elAnnotations), i2.annotations.drawAxesAnnotations()), !a2.globals.noData) {
            if (a2.config.tooltip.enabled && !a2.globals.noData && i2.w.globals.tooltip.drawTooltip(e2.xyRatios), a2.globals.axisCharts && (a2.globals.isXNumeric || a2.config.xaxis.convertedCatToNumeric || a2.globals.isTimelineBar)) (a2.config.chart.zoom.enabled || a2.config.chart.selection && a2.config.chart.selection.enabled || a2.config.chart.pan && a2.config.chart.pan.enabled) && i2.zoomPanSelection.init({ xyRatios: e2.xyRatios });
            else {
